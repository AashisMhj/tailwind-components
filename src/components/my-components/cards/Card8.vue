<template>
    <div class="max-w-sm rounded-sm overflow-hidden shadow-lg">
        ...
        <div class="h-64 bg-cover hover:bg-gray"
            style="background-image: url('https://user-images.githubusercontent.com/5419306/64431443-71823880-d088-11e9-9bd7-1b314f94dc1f.png')">
        </div>
